...
// message must always get the same verdict, for free, in microseconds.
//
// This is the whole moderation decision. There is no model behind it: the
// ruleset scores 100% recall and 100% precision on the eval corpus, and the
// grey band goes to a human in the CRM queue rather than to a guess.
//
