...
export function compose({
  ...
  const llm = createLlmService({ runtime });

  const moderation = createModerationService({
    runtime, llm: client, escalationEnabled,
  ...
  const services = { catalog, identity, wallet, social, live, admin, moderation, llm };
  ...
  Object.assign(registry, {
    ...
    llm: createLlmRouter({ runtime, service: llm }),
  });
